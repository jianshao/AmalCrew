  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#fbfaf7] text-ink">
      ...
      <footer className="px-5 py-12 sm:px-8">
        <div className="mx-auto flex max-w-[1180px] flex-col gap-7 border-t border-stone-200 pt-8 sm:flex-row sm:items-end sm:justify-between"><div><Brand /><p className="mt-4 max-w-sm text-sm leading-6 text-stone-500">Simple workforce time tracking and confirmations for UAE and GCC field teams.</p></div><div className="text-sm text-stone-500 sm:text-end"><nav className="flex flex-wrap gap-x-4 gap-y-2 font-semibold text-brand-700 sm:justify-end"><Link href="/en/pricing">Pricing</Link><Link href="/en/contact">Contact</Link><Link href="/en/privacy">Privacy</Link><Link href="/en/terms">Terms</Link></nav><p className="mt-3">Dubai · United Arab Emirates</p><p className="mt-2 text-xs">© {new Date().getFullYear()} AmalCrew. All rights reserved.</p></div></div>
      </footer>
