...
export function ContactPage({ lang, telegramContactUrl }: { lang: ContactLanguage; telegramContactUrl: string | null }) {
  ...
  const selectedPlan = ["BASIC", "ADVANCED", "PROFESSIONAL"].includes(planFromUrl) ? planFromUrl : null;
