    ...
    <div dir={content.dir} className="min-h-screen overflow-hidden bg-[#fbfaf7] text-ink">
      ...
      <footer className="px-5 py-12 sm:px-8">
        <div className="mx-auto flex max-w-[1240px] flex-col gap-8 border-t border-stone-200 pt-8 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="text-start text-xs text-stone-500 sm:text-end">{lang === "en" ? <Link href="/en/construction-timesheet-software-uae" className="font-semibold text-brand-700 transition hover:text-brand-800">Construction timesheet software for UAE</Link> : null}<p className={lang === "en" ? "mt-3" : undefined}>{content.footer.location}</p><p className="mt-2">© {new Date().getFullYear()} AmalCrew. {content.footer.copyright}</p></div>
        </div>
      </footer>
